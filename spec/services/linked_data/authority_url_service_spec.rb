  ...
  describe '.build_url' do
    ...
    context 'when authority is not registered' do
      ...
      it 'raises error' do
        ...
        expect { described_class.build_url(action_config:, action:, action_request:, request_header:) }
    ...
    context 'when no errors' do
      subject do
        described_class.build_url(action_config:, action:, action_request:, request_header:)
      end
