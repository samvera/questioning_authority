  ...
  module LinkedData
    class SearchQuery
      ...
      def ldpaths_for_search
        ...
        ldpaths[:id] = id_ldpath.presence || :subject_uri
        ldpaths[:sort] = sort_ldpath.presence || ldpaths[:label]
        ldpaths
      end
      ...
      def preds_for_search
        ...
        preds[:id] = id_predicate.presence || :subject_uri
        preds[:sort] = sort_predicate.presence || preds[:label]
        preds
      end
